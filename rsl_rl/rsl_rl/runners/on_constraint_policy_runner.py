...
from rsl_rl.modules import ActorCriticRMA, ActorCriticBarlowTwins
from rsl_rl.algorithms import NP3O
from rsl_rl.env import VecEnv
from rsl_rl.modules.depth_backbone import DepthOnlyFCBackbone58x87, RecurrentDepthBackbone
from legged_gym.utils.helpers import hard_phase_schedualer, partial_checkpoint_load
...
class OnConstraintPolicyRunner:
    ...
    def __init__(self,
        ...
        self.dagger_update_freq = self.alg_cfg["dagger_update_freq"] # 教师模型更新频率
